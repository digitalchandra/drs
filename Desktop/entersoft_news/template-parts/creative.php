...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
          <li class="name-cat-contrl"> <a href="<?php get_category_link('6');?>">  <?php echo get_cat_name('6');?></a></li>  
...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
                		  <li class="name-cat-contrl"> <a href="<?php get_category_link('7');?>">  <?php echo get_cat_name('7');?></a></li>  
          <li class="line-control"> 
             <hr> </li>
      </ul>
      </div>
...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
                 		  <li class="name-cat-contrl"> <a href="<?php get_category_link('8');?>">   <?php echo get_cat_name('8');?></a></li>  
          <li class="line-control"> 
             <hr> </li>
      </ul>
      </div>
