...
<!--Blog Start From Here-->
  ...
  <div class="container-sm">
    <div class="row news_section_background">
		    <div class="seperator">
				<ul class="sep-cat">
				          		  <li class="name-cat-contrl"> <a href="<?php get_category_link('23');?>">   <?php echo get_cat_name('23');?></a></li>  
				  <li class="line-control"> 
					 <hr> </li>
			  </ul>
			  </div>
                   <?php
                    $category_name = get_cat_name('23');
        ...
        <?php endwhile; endif?>
        	<div class="seemore1">
					<a href="<?php echo get_category_link('23');?>"> थप हेर्नुहोस् </a>
