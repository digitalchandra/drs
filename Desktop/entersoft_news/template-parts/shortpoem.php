...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
          <li class="name-cat-contrl"> <a href="<?php get_category_link('16');?>">  <?php echo get_cat_name('16');?></a></li>  
...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
                		  <li class="name-cat-contrl"> <a href="<?php get_category_link('17');?>">  <?php echo get_cat_name('17');?></a></li>  
          <li class="line-control"> 
             <hr> </li>
      </ul>
      </div>
...
<div class="col-lx-4 col-md-4 col-sm-4 mb-auto ">
  ...
  <div class="seperator">
        <ul class="sep-cat">
                 		  <li class="name-cat-contrl"> <a href="<?php get_category_link('19');?>">   <?php echo get_cat_name('19');?></a></li>  
          <li class="line-control"> 
             <hr> </li>
      </ul>
      </div>
